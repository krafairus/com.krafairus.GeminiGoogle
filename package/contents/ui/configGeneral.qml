...
Kirigami.FormLayout {
    ...
    QQC2.Label {
		font.pixelSize: 8
		font.italic: true
		text:i18n("This is enabled by default to allow for quick code/recipe/etc but can be disabled if you are worried about Bard Google  examining your system clipboard");
	}
