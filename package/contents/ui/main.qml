	...
	Plasmoid.fullRepresentation: ColumnLayout {
		...
		Timer {
			...
			onTriggered: if(	!loadedsuccessfully &&
					...
					console.log("Failed to load Gemini Google page, reloading as we are hidden..");
					...
					RowLayout {
						...
						RowLayout {
							...
							PlasmaComponents.ToolButton {
								text: i18n("Back to Gemini")
								visible: !gptWebView.url.toString().match(/gemini\.google\.com\/(|chat|auth)/);
								enabled: visible
								...
								onClicked: gptWebView.url = "https://gemini.google.com/signin?continue=https%3A%2F%2Fgemini.google.com%2F";
							}
						...
						PlasmaComponents.ToolButton {
							...
							text: i18n("Im a Pro")
							visible: gptWebView.url.toString().match(/gemini\.google\.com\/auth/);
		...
		WebEngineView {
				...
				width: 340
				height: 561
				url: "https://gemini.google.com/signin?continue=https%3A%2F%2Fgemini.google.com%2F"

				profile: WebEngineProfile {
					id: chatGptProfile
					storageName: "gemini-google"
					offTheRecord: false
